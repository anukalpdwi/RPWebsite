...
const terms = [
  {
    ...
    events: [
      { date: "April 1, 2026", event: "New Academic Session Begins" },
      { date: "April 10, 2026", event: "Annual Day Celebration" },
      { date: "May 15-20, 2026", event: "First Unit Test" },
      { date: "June 5, 2026", event: "World Environment Day Activities" },
      { date: "July 1-15, 2026", event: "Mid-Term Examination" },
      { date: "August 15, 2026", event: "Independence Day Celebration" },
      { date: "September 5, 2026", event: "Teachers' Day Celebration" },
      { date: "September 20-30, 2026", event: "First Term Examination" },
    ]
  },
  {
    name: "Second Term",
    ...
    events: [
      { date: "October 2, 2026", event: "Gandhi Jayanti Celebration" },
      { date: "October 24-28, 2026", event: "Diwali Vacation" },
      { date: "November 14, 2026", event: "Children's Day Celebration" },
      { date: "November 20, 2026", event: "Inter-school Science Exhibition" },
      { date: "December 15, 2026", event: "Annual Sports Meet" },
      { date: "December 25-January 1, 2027", event: "Winter Vacation" },
      { date: "January 26, 2027", event: "Republic Day Celebration" },
      { date: "February 5-10, 2027", event: "Pre-Board Examination for Classes X & XII" },
      { date: "March 1-15, 2027", event: "Annual Examination" },
      { date: "March 31, 2027", event: "Academic Session Ends" },
    ]
  }
];
